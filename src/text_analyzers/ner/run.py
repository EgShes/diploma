...
from src.text_analyzers.ner.runner import NerPreprocessor, NerAnalyzer, NerPostprocessor
...
if __name__ == "__main__":
    ...
    anal = NerAnalyzer.load(
        navec_embeddings_path=Path(
            "/home/egor/Downloads/navec_news_v1_1B_250K_300d_100q.tar"
        ),
